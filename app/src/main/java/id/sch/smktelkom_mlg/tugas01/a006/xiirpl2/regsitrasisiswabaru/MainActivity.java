package id.sch.smktelkom_mlg.tugas01.a006.xiirpl2.regsitrasisiswabaru;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbD = (CheckBox) findViewById(R.id.checkBoxspkbola);
        cbA = (CheckBox) findViewById(R.id.checkBoxKomputer);
        cbT = (CheckBox) findViewById(R.id.checkBoxbasket);
    }
